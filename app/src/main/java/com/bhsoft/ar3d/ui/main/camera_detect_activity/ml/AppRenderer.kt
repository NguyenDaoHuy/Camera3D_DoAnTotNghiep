 ...
 */
class AppRenderer(val activity: Camera_Detect_Activity) : DefaultLifecycleObserver, SampleRender.Renderer, CoroutineScope by MainScope() {
  companion object {
...
//      // Use a boolean and check its state in onDrawFrame to interact with ơ]\0the camera image.
//      scanButtonWasPressed = true
//      view.setScanningActive(true)
//      hideSnackbar()
//    }
